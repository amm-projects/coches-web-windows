import {
  require_react_dom
} from "./chunk-RIVBLVCM.js";
import {
  require_react
} from "./chunk-NEKDJIDX.js";
import {
  __commonJS,
  __export,
  __toESM
...
var require_object_inspect = __commonJS({
  "node_modules/object-inspect/index.js"(exports2, module2) {
    ...
    var toStringTag3 = typeof Symbol === "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === hasShammedSymbols ? "object" : "symbol") ? Symbol.toStringTag : null;
    ...
    module2.exports = function inspect_(obj, options, depth, seen) {
      ...
      if (!isDate4(obj) && !isRegExp4(obj)) {
        ...
        var stringTag6 = !isPlainObject4 && toStringTag3 && Object(obj) === obj && toStringTag3 in obj ? $slice.call(toStr(obj), 8, -1) : protoTag ? "Object" : "";
    ...
    function canTrustToString(obj) {
      return !toStringTag3 || !(typeof obj === "object" && (toStringTag3 in obj || typeof obj[toStringTag3] !== "undefined"));
    }
...
var require_implementation = __commonJS({
  "node_modules/function-bind/implementation.js"(exports2, module2) {
    ...
    module2.exports = function bind4(that) {
      var target = this;
...
var require_actualApply = __commonJS({
  "node_modules/call-bind-apply-helpers/actualApply.js"(exports2, module2) {
    ...
    module2.exports = $reflectApply || bind4.call($call, $apply);
  }
});
...
var require_call_bind_apply_helpers = __commonJS({
  "node_modules/call-bind-apply-helpers/index.js"(exports2, module2) {
    ...
    module2.exports = function callBindBasic(args) {
      ...
      return $actualApply(bind4, $call, args);
    };
  }
});
...
var require_hasown = __commonJS({
  "node_modules/hasown/index.js"(exports2, module2) {
    ...
    var bind4 = require_function_bind();
    module2.exports = bind4.call(call, $hasOwn);
  }
});
...
var require_get_intrinsic = __commonJS({
  "node_modules/get-intrinsic/index.js"(exports2, module2) {
    ...
    var $concat = bind4.call($call, Array.prototype.concat);
    var $spliceApply = bind4.call($apply, Array.prototype.splice);
    var $replace = bind4.call($call, String.prototype.replace);
    var $strSlice = bind4.call($call, String.prototype.slice);
    var $exec = bind4.call($call, RegExp.prototype.exec);
...
var require_utils = __commonJS({
  "node_modules/qs/lib/utils.js"(exports2, module2) {
    ...
    var arrayToObject3 = function arrayToObject4(source, options) {
    ...
    var merge4 = function merge5(target, source, options) {
      ...
      if (typeof source !== "object" && typeof source !== "function") {
        if (isArray4(target)) {
          ...
          if (options && typeof options.arrayLimit === "number" && nextIndex > options.arrayLimit) {
            return markOverflow(arrayToObject3(target.concat(source), options), nextIndex);
          }
      ...
      if (!target || typeof target !== "object") {
        ...
        if (options && typeof options.arrayLimit === "number" && combined.length > options.arrayLimit) {
          return markOverflow(arrayToObject3(combined, options), combined.length - 1);
        }
        return combined;
      }
      var mergeTarget = target;
      if (isArray4(target) && !isArray4(source)) {
        mergeTarget = arrayToObject3(target, options);
      }
      if (isArray4(target) && isArray4(source)) {
    ...
    var combine = function combine2(a, b, arrayLimit, plainObjects) {
      ...
      if (result2.length > arrayLimit) {
        return markOverflow(arrayToObject3(result2, { plainObjects }), result2.length - 1);
      }
      return result2;
    };
...
var require_stringify = __commonJS({
  "node_modules/qs/lib/stringify.js"(exports2, module2) {
    ...
    var sentinel = {};
    var stringify2 = function stringify3(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter4, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
      var obj = object;
      ...
      if (obj === null) {
        if (strictNullHandling) {
          return encoder && !encodeValuesOnly ? encoder(prefix, defaults4.encoder, charset, "key", format) : prefix;
        }
        obj = "";
      }
      if (isNonNullishPrimitive(obj) || utils.isBuffer(obj)) {
        if (encoder) {
          var keyValue = encodeValuesOnly ? prefix : encoder(prefix, defaults4.encoder, charset, "key", format);
      ...
      var adjustedPrefix = commaRoundTrip && isArray4(obj) && obj.length === 1 ? encodedPrefix + "[]" : encodedPrefix;
      if (allowEmptyArrays && isArray4(obj) && obj.length === 0) {
      ...
      for (var j = 0; j < objKeys.length; ++j) {
        ...
        var keyPrefix = isArray4(obj) ? typeof generateArrayPrefix === "function" ? generateArrayPrefix(adjustedPrefix, encodedKey) : adjustedPrefix : adjustedPrefix + (allowDots ? "." + encodedKey : "[" + encodedKey + "]");
  ...
  "node_modules/qs/lib/parse.js"(exports2, module2) {
    ...
    var parseValues = function parseQueryStringValues(str, options) {
      ...
      for (i = 0; i < parts.length; ++i) {
          ...
          if (key !== null) {
            val = utils.maybeMap(
              parseArrayValue(
                part.slice(pos + 1),
                options,
                isArray4(obj[key]) ? obj[key].length : 0
              ),
              function(encodedVal) {
        ...
        if (options.comma && isArray4(val) && val.length > options.arrayLimit) {
...
var hasOwnProperty27 = (({ hasOwnProperty: hasOwnProperty29 }) => (obj, prop) => hasOwnProperty29.call(obj, prop))(Object.prototype);
...
var utils_default = {
  ...
  matchAll,
  isHTMLForm,
  hasOwnProperty: hasOwnProperty27,
  hasOwnProp: hasOwnProperty27,
...
function transformData(fns, response) {
  const config3 = this || defaults_default2;
...
function mergeConfig(config1, config22) {
  ...
  utils_default.forEach(
    ...
    function computeConfigValue(prop) {
      ...
      const configValue = merge4(config1[prop], config22[prop], prop);
...
var xhr_default = isXHRAdapterSupported && function(config3) {
  return new Promise(function dispatchXhrRequest(resolve, reject2) {
    ...
    request2.onabort = function handleAbort() {
      ...
      reject2(new AxiosError_default("Request aborted", AxiosError_default.ECONNABORTED, config3, request2));
      request2 = null;
    };
    ...
    if (_config.cancelToken || _config.signal) {
      onCanceled = (cancel) => {
        ...
        reject2(!cancel || cancel.type ? new CanceledError_default(null, config3, request2) : cancel);
        request2.abort();
        request2 = null;
      };
    ...
    if (protocol && platform_default.protocols.indexOf(protocol) === -1) {
      reject2(new AxiosError_default("Unsupported protocol " + protocol + ":", AxiosError_default.ERR_BAD_REQUEST, config3));
      return;
    }
...
var trackStream = (stream, chunkSize, onProgress, onFinish) => {
  ...
  return new ReadableStream({
    async pull(controller) {
      try {
        const { done: done3, value } = await iterator3.next();
        if (done3) {
          _onFinish();
          controller.close();
          return;
  ...
  return async (config3) => {
    ...
    try {
      ...
      if (err && err.name === "TypeError" && /Load failed|fetch/i.test(err.message)) {
        throw Object.assign(
          new AxiosError_default("Network Error", AxiosError_default.ERR_NETWORK, config3, request2, err && err.response),
          {
            cause: err.cause || err
          }
        );
...
function getAdapter(adapters, config3) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    if (adapter3 && (utils_default.isFunction(adapter3) || (adapter3 = adapter3.get(config3)))) {
      break;
    }
...
function dispatchRequest(config3) {
  ...
  const adapter3 = adapters_default.getAdapter(config3.adapter || defaults_default2.adapter, config3);
  return adapter3(config3).then(function onAdapterResolution(response) {
    throwIfCancellationRequested(config3);
...
var Axios = class {
  ...
  _request(configOrUrl, config3) {
    ...
    const { transitional: transitional3, paramsSerializer, headers } = config3;
    ...
    this.interceptors.request.forEach(function unshiftRequestInterceptors(interceptor) {
      ...
      const transitional4 = config3.transitional || transitional_default;
      const legacyInterceptorReqResOrdering = transitional4 && transitional4.legacyInterceptorReqResOrdering;
...
utils_default.forEach(["delete", "get", "head", "options"], function forEachMethodNoData(method2) {
  Axios.prototype[method2] = function(url, config3) {
...
var Config = class {
  ...
  extend(defaults4) {
    if (defaults4) {
      this.defaults = { ...this.defaults, ...defaults4 };
    }
    return this;
  }
  replace(newConfig) {
...
function resetFormFields(formElement, defaults4, fieldNames) {
  if (!formElement) {
    return;
  }
  ...
  if (resetEntireForm) {
    ...
    fieldNames = [.../* @__PURE__ */ new Set([...defaults4.keys(), ...formData.keys(), ...formElementNames])];
  }
  let hasChanged = false;
  fieldNames.forEach((fieldName) => {
    const elements = formElement.elements.namedItem(fieldName);
    if (elements) {
      if (resetFieldElements(elements, defaults4.getAll(fieldName))) {
        hasChanged = true;
      }
    }
  });
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/bind.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/utils.js
...
var isUndefined3 = typeOfTest2("undefined");
function isBuffer3(val) {
  return val !== null && !isUndefined3(val) && val.constructor !== null && !isUndefined3(val.constructor) && isFunction4(val.constructor.isBuffer) && val.constructor.isBuffer(val);
}
...
function isArrayBufferView2(val) {
  ...
  if (typeof ArrayBuffer !== "undefined" && ArrayBuffer.isView) {
    ...
    result2 = val && val.buffer && isArrayBuffer3(val.buffer);
  }
  return result2;
}
var isString3 = typeOfTest2("string");
var isFunction4 = typeOfTest2("function");
...
var isEmptyObject2 = (val) => {
  if (!isObject3(val) || isBuffer3(val)) {
    return false;
  }
  try {
    return Object.keys(val).length === 0 && Object.getPrototypeOf(val) === Object.prototype;
...
var isFile3 = kindOfTest2("File");
var isBlob2 = kindOfTest2("Blob");
var isFileList2 = kindOfTest2("FileList");
var isStream2 = (val) => isObject3(val) && isFunction4(val.pipe);
var isFormData3 = (thing) => {
  let kind;
  return thing && (typeof FormData === "function" && thing instanceof FormData || isFunction4(thing.append) && ((kind = kindOf2(thing)) === "formdata" || // detect form-data instance
...
var isContextDefined2 = (context) => !isUndefined3(context) && context !== _global2;
function merge3() {
  ...
  const assignValue2 = (val, key) => {
    ...
    if (isPlainObject3(result2[targetKey]) && isPlainObject3(val)) {
      ...
      result2[targetKey] = val.slice();
    } else if (!skipUndefined || !isUndefined3(val)) {
      result2[targetKey] = val;
    }
  };
  for (let i = 0, l = arguments.length; i < l; i++) {
    arguments[i] && forEach3(arguments[i], assignValue2);
  }
  return result2;
}
...
var hasOwnProperty28 = (({ hasOwnProperty: hasOwnProperty29 }) => (obj, prop) => hasOwnProperty29.call(obj, prop))(Object.prototype);
var isRegExp3 = kindOfTest2("RegExp");
var reduceDescriptors2 = (obj, reducer) => {
  const descriptors = Object.getOwnPropertyDescriptors(obj);
  const reducedDescriptors = {};
  forEach3(descriptors, (descriptor, name) => {
    let ret;
    if ((ret = reducer(descriptor, name, obj)) !== false) {
      reducedDescriptors[name] = ret || descriptor;
    }
...
var freezeMethods2 = (obj) => {
  reduceDescriptors2(obj, (descriptor, name) => {
    if (isFunction4(obj) && ["arguments", "caller", "callee"].indexOf(name) !== -1) {
      return false;
    }
    const value = obj[name];
    if (!isFunction4(value)) return;
    descriptor.enumerable = false;
    if ("writable" in descriptor) {
      descriptor.writable = false;
      return;
...
function isSpecCompliantForm2(thing) {
  return !!(thing && isFunction4(thing.append) && thing[toStringTag2] === "FormData" && thing[iterator2]);
}
...
var isThenable2 = (thing) => thing && (isObject3(thing) || isFunction4(thing)) && isFunction4(thing.then) && isFunction4(thing.catch);
...
})(typeof setImmediate === "function", isFunction4(_global2.postMessage));
...
var isIterable2 = (thing) => thing != null && isFunction4(thing[iterator2]);
var utils_default2 = {
  isArray: isArray3,
  ...
  hasOwnProperty: hasOwnProperty28,
  hasOwnProp: hasOwnProperty28,
  // an alias to avoid ESLint no-prototype-builtins detection
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/AxiosError.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/null.js
var null_default2 = null;

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/toFormData.js
...
var predicates2 = utils_default2.toFlatObject(utils_default2, {}, null, function filter3(prop) {
  return /^is[A-Z]/.test(prop);
});
function toFormData3(obj, formData, options) {
  ...
  function convertValue(value) {
    ...
    if (utils_default2.isBoolean(value)) {
      return value.toString();
    }
  ...
  function build(value, path) {
    ...
    utils_default2.forEach(value, function each(el, key) {
      const result2 = !(utils_default2.isUndefined(el) || el === null) && visitor.call(
        formData,
        el,
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/AxiosURLSearchParams.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/buildURL.js
...
function buildURL2(url, params, options) {
  ...
  if (serializeFn) {
    ...
    serializedParams = utils_default2.isURLSearchParams(params) ? params.toString() : new AxiosURLSearchParams_default2(params, _options).toString(_encode);
  }
  if (serializedParams) {
    const hashmarkIndex = url.indexOf("#");
    if (hashmarkIndex !== -1) {
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/InterceptorManager.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/defaults/transitional.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/platform/browser/classes/URLSearchParams.js
var URLSearchParams_default2 = typeof URLSearchParams !== "undefined" ? URLSearchParams : AxiosURLSearchParams_default2;

// node_modules/laravel-precognition/node_modules/axios/lib/platform/browser/classes/FormData.js
var FormData_default2 = typeof FormData !== "undefined" ? FormData : null;

// node_modules/laravel-precognition/node_modules/axios/lib/platform/browser/classes/Blob.js
var Blob_default2 = typeof Blob !== "undefined" ? Blob : null;

// node_modules/laravel-precognition/node_modules/axios/lib/platform/browser/index.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/platform/common/utils.js
var utils_exports2 = {};
...
// node_modules/laravel-precognition/node_modules/axios/lib/platform/index.js
var platform_default2 = {
  ...utils_exports2,
  ...browser_default2
};

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/toURLEncodedForm.js
function toURLEncodedForm2(data, options) {
  return toFormData_default2(data, new platform_default2.classes.URLSearchParams(), {
    visitor: function(value, key, path, helpers) {
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/formDataToJSON.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/defaults/index.js
...
var defaults3 = {
  ...
  transformRequest: [function transformRequest2(data, headers) {
    ...
    const isFormData4 = utils_default2.isFormData(data);
    if (isFormData4) {
  ...
  transformResponse: [function transformResponse2(data) {
    const transitional3 = this.transitional || defaults3.transitional;
    const forcedJSONParsing = transitional3 && transitional3.forcedJSONParsing;
    const JSONRequested = this.responseType === "json";
  ...
  validateStatus: function validateStatus2(status2) {
    return status2 >= 200 && status2 < 300;
  },
  headers: {
    common: {
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/parseHeaders.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/AxiosHeaders.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/transformData.js
function transformData2(fns, response) {
  const config3 = this || defaults_default3;
  const context = response || config3;
...
// node_modules/laravel-precognition/node_modules/axios/lib/cancel/isCancel.js
function isCancel3(value) {
  return !!(value && value.__CANCEL__);
}

// node_modules/laravel-precognition/node_modules/axios/lib/cancel/CanceledError.js
var CanceledError3 = class extends AxiosError_default2 {
  /**
   * A `CanceledError` is an object that is thrown when an operation is canceled.
   *
   * @param {string=} message The message.
   ...
   */
  constructor(message, config3, request2) {
    super(message == null ? "canceled" : message, AxiosError_default2.ERR_CANCELED, config3, request2);
    this.name = "CanceledError";
    this.__CANCEL__ = true;
  }
};
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/settle.js
function settle2(resolve, reject2, response) {
  const validateStatus3 = response.config.validateStatus;
  if (!response.status || !validateStatus3 || validateStatus3(response.status)) {
    resolve(response);
  } else {
    reject2(new AxiosError_default2(
      "Request failed with status code " + response.status,
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/parseProtocol.js
function parseProtocol2(url) {
  const match = /^([-+\w]{1,25})(:?\/\/|:)/.exec(url);
  return match && match[1] || "";
}

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/speedometer.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/throttle.js
...
var throttle_default3 = throttle3;

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/progressEventReducer.js
var progressEventReducer2 = (listener, isDownloadStream, freq = 3) => {
  let bytesNotified = 0;
  const _speedometer = speedometer_default2(50, 250);
  return throttle_default3((e) => {
    const loaded = e.loaded;
    const total = e.lengthComputable ? e.total : void 0;
    const progressBytes = loaded - bytesNotified;
    const rate = _speedometer(progressBytes);
...
var asyncDecorator2 = (fn) => (...args) => utils_default2.asap(() => fn(...args));

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/isURLSameOrigin.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/cookies.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/isAbsoluteURL.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/combineURLs.js
function combineURLs2(baseURL, relativeURL) {
  return relativeURL ? baseURL.replace(/\/?\/$/, "") + "/" + relativeURL.replace(/^\/+/, "") : baseURL;
}

// node_modules/laravel-precognition/node_modules/axios/lib/core/buildFullPath.js
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/mergeConfig.js
var headersToObject2 = (thing) => thing instanceof AxiosHeaders_default2 ? { ...thing } : thing;
function mergeConfig3(config1, config22) {
  config22 = config22 || {};
  const config3 = {};
  function getMergedValue(target, source, prop, caseless) {
  ...
  utils_default2.forEach(
    ...
    function computeConfigValue(prop) {
      if (prop === "__proto__" || prop === "constructor" || prop === "prototype")
        return;
      const merge4 = utils_default2.hasOwnProp(mergeMap, prop) ? mergeMap[prop] : mergeDeepProperties;
      const configValue = merge4(config1[prop], config22[prop], prop);
      utils_default2.isUndefined(configValue) && merge4 !== mergeDirectKeys || (config3[prop] = configValue);
    }
  );
  return config3;
}

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/resolveConfig.js
var resolveConfig_default2 = (config3) => {
  const newConfig = mergeConfig3({}, config3);
  let { data, withXSRFToken, xsrfHeaderName, xsrfCookieName, headers, auth } = newConfig;
  newConfig.headers = headers = AxiosHeaders_default2.from(headers);
  newConfig.url = buildURL2(buildFullPath2(newConfig.baseURL, newConfig.url, newConfig.allowAbsoluteUrls), config3.params, config3.paramsSerializer);
  if (auth) {
    headers.set(
      "Authorization",
      "Basic " + btoa((auth.username || "") + ":" + (auth.password ? unescape(encodeURIComponent(auth.password)) : ""))
...
// node_modules/laravel-precognition/node_modules/axios/lib/adapters/xhr.js
...
var xhr_default2 = isXHRAdapterSupported2 && function(config3) {
  return new Promise(function dispatchXhrRequest(resolve, reject2) {
    ...
    request2.onabort = function handleAbort() {
      ...
      reject2(new AxiosError_default2("Request aborted", AxiosError_default2.ECONNABORTED, config3, request2));
      request2 = null;
    };
    request2.onerror = function handleError(event) {
      const msg = event && event.message ? event.message : "Network Error";
      const err = new AxiosError_default2(msg, AxiosError_default2.ERR_NETWORK, config3, request2);
      err.event = event || null;
      reject2(err);
      request2 = null;
    };
    ...
    if (_config.cancelToken || _config.signal) {
      onCanceled = (cancel) => {
        ...
        reject2(!cancel || cancel.type ? new CanceledError_default2(null, config3, request2) : cancel);
        request2.abort();
        request2 = null;
      };
      _config.cancelToken && _config.cancelToken.subscribe(onCanceled);
    ...
    if (protocol && platform_default2.protocols.indexOf(protocol) === -1) {
      reject2(new AxiosError_default2("Unsupported protocol " + protocol + ":", AxiosError_default2.ERR_BAD_REQUEST, config3));
      return;
    }
    request2.send(requestData || null);
  });
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/composeSignals.js
var composeSignals2 = (signals, timeout) => {
  ...
  if (timeout || length) {
    ...
    let timer = timeout && setTimeout(() => {
      timer = null;
      onabort(new AxiosError_default2(`timeout of ${timeout}ms exceeded`, AxiosError_default2.ETIMEDOUT));
    }, timeout);
    const unsubscribe = () => {
      if (signals) {
        timer && clearTimeout(timer);
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/trackStream.js
var streamChunk2 = function* (chunk2, chunkSize) {
  let len = chunk2.byteLength;
  if (!chunkSize || len < chunkSize) {
    yield chunk2;
    return;
...
var readBytes2 = async function* (iterable, chunkSize) {
  for await (const chunk2 of readStream2(iterable)) {
    yield* streamChunk2(chunk2, chunkSize);
  }
};
...
// node_modules/laravel-precognition/node_modules/axios/lib/adapters/fetch.js
var DEFAULT_CHUNK_SIZE2 = 64 * 1024;
var { isFunction: isFunction5 } = utils_default2;
var globalFetchAPI2 = (({ Request: Request2, Response: Response2 }) => ({
  Request: Request2,
  Response: Response2
}))(utils_default2.global);
var {
...
var factory2 = (env) => {
  ...
  const { fetch: envFetch, Request: Request2, Response: Response2 } = env;
  const isFetchSupported = envFetch ? isFunction5(envFetch) : typeof fetch === "function";
  const isRequestSupported = isFunction5(Request2);
  const isResponseSupported = isFunction5(Response2);
  if (!isFetchSupported) {
    return false;
  }
  const isReadableStreamSupported = isFetchSupported && isFunction5(ReadableStream3);
  const encodeText = isFetchSupported && (typeof TextEncoder3 === "function" ? /* @__PURE__ */ ((encoder) => (str) => encoder.encode(str))(new TextEncoder3()) : async (str) => new Uint8Array(await new Request2(str).arrayBuffer()));
  const supportsRequestStream = isRequestSupported && isReadableStreamSupported && test2(() => {
    let duplexAccessed = false;
    const hasContentType = new Request2(platform_default2.origin, {
      body: new ReadableStream3(),
      method: "POST",
      get duplex() {
        duplexAccessed = true;
        return "half";
  ...
  const supportsResponseStream = isResponseSupported && isReadableStreamSupported && test2(() => utils_default2.isReadableStream(new Response2("").body));
  const resolvers = {
    stream: supportsResponseStream && ((res) => res.body)
  };
  isFetchSupported && (() => {
    ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((type) => {
      !resolvers[type] && (resolvers[type] = (res, config3) => {
        ...
        throw new AxiosError_default2(`Response type '${type}' is not supported`, AxiosError_default2.ERR_NOT_SUPPORT, config3);
      });
    });
  })();
  const getBodyLength = async (body) => {
    ...
    if (utils_default2.isSpecCompliantForm(body)) {
      const _request = new Request2(platform_default2.origin, {
        method: "POST",
        body
      });
      return (await _request.arrayBuffer()).byteLength;
  ...
  return async (config3) => {
    let {
      ...
      withCredentials = "same-origin",
      fetchOptions
    } = resolveConfig_default2(config3);
    let _fetch = envFetch || fetch;
    responseType = responseType ? (responseType + "").toLowerCase() : "text";
    ...
    try {
      ...
      responseType = responseType || "text";
      let responseData = await resolvers[utils_default2.findKey(resolvers, responseType) || "text"](response, config3);
      !isStreamResponse && unsubscribe && unsubscribe();
      return await new Promise((resolve, reject2) => {
        settle2(resolve, reject2, {
          data: responseData,
      ...
      if (err && err.name === "TypeError" && /Load failed|fetch/i.test(err.message)) {
        throw Object.assign(
          new AxiosError_default2("Network Error", AxiosError_default2.ERR_NETWORK, config3, request2, err && err.response),
          {
            cause: err.cause || err
          }
        );
      }
      throw AxiosError_default2.from(err, err && err.code, config3, request2, err && err.response);
    }
  };
};
var seedCache2 = /* @__PURE__ */ new Map();
var getFetch2 = (config3) => {
  let env = config3 && config3.env || {};
  const { fetch: fetch2, Request: Request2, Response: Response2 } = env;
  const seeds = [
    Request2,
...
var adapter2 = getFetch2();

// node_modules/laravel-precognition/node_modules/axios/lib/adapters/adapters.js
var knownAdapters2 = {
  http: null_default2,
  xhr: xhr_default2,
  fetch: {
...
var isResolvedHandle2 = (adapter3) => utils_default2.isFunction(adapter3) || adapter3 === null || adapter3 === false;
function getAdapter3(adapters, config3) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    if (!isResolvedHandle2(nameOrAdapter)) {
      adapter3 = knownAdapters2[(id = String(nameOrAdapter)).toLowerCase()];
      if (adapter3 === void 0) {
        throw new AxiosError_default2(`Unknown adapter '${id}'`);
      }
    }
    if (adapter3 && (utils_default2.isFunction(adapter3) || (adapter3 = adapter3.get(config3)))) {
      break;
    }
    rejectedReasons[id || "#" + i] = adapter3;
  }
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/dispatchRequest.js
function throwIfCancellationRequested2(config3) {
  if (config3.cancelToken) {
    config3.cancelToken.throwIfRequested();
  }
  if (config3.signal && config3.signal.aborted) {
    throw new CanceledError_default2(null, config3);
  }
}
function dispatchRequest2(config3) {
  throwIfCancellationRequested2(config3);
  config3.headers = AxiosHeaders_default2.from(config3.headers);
  ...
  const adapter3 = adapters_default2.getAdapter(config3.adapter || defaults_default3.adapter, config3);
  return adapter3(config3).then(function onAdapterResolution(response) {
    throwIfCancellationRequested2(config3);
...
// node_modules/laravel-precognition/node_modules/axios/lib/env/data.js
var VERSION4 = "1.13.5";

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/validator.js
var validators3 = {};
["object", "boolean", "number", "function", "string", "symbol"].forEach((type, i) => {
...
function assertOptions2(options, schema, allowUnknown) {
  ...
  while (i-- > 0) {
    ...
    if (validator) {
      ...
      const result2 = value === void 0 || validator(value, opt, options);
      if (result2 !== true) {
        throw new AxiosError_default2("option " + opt + " must be " + result2, AxiosError_default2.ERR_BAD_OPTION_VALUE);
      }
      continue;
    }
    if (allowUnknown !== true) {
...
// node_modules/laravel-precognition/node_modules/axios/lib/core/Axios.js
...
var Axios3 = class {
  ...
  _request(configOrUrl, config3) {
    ...
    if (transitional3 !== void 0) {
      validator_default2.assertOptions(transitional3, {
        ...
        legacyInterceptorReqResOrdering: validators4.transitional(validators4.boolean)
      }, false);
    }
    if (paramsSerializer != null) {
    ...
    validator_default2.assertOptions(config3, {
    ...
    config3.headers = AxiosHeaders_default2.concat(contextHeaders, headers);
    const requestInterceptorChain = [];
    let synchronousRequestInterceptors = true;
    this.interceptors.request.forEach(function unshiftRequestInterceptors(interceptor) {
      if (typeof interceptor.runWhen === "function" && interceptor.runWhen(config3) === false) {
      ...
      synchronousRequestInterceptors = synchronousRequestInterceptors && interceptor.synchronous;
      const transitional4 = config3.transitional || transitional_default2;
      const legacyInterceptorReqResOrdering = transitional4 && transitional4.legacyInterceptorReqResOrdering;
      if (legacyInterceptorReqResOrdering) {
        requestInterceptorChain.unshift(interceptor.fulfilled, interceptor.rejected);
      } else {
    ...
    let len;
    if (!synchronousRequestInterceptors) {
      const chain2 = [dispatchRequest2.bind(this), void 0];
      chain2.unshift(...requestInterceptorChain);
      chain2.push(...responseInterceptorChain);
      len = chain2.length;
      promise = Promise.resolve(config3);
  ...
  getUri(config3) {
    ...
    return buildURL2(fullPath, config3.params, config3.paramsSerializer);
  }
};
utils_default2.forEach(["delete", "get", "head", "options"], function forEachMethodNoData2(method2) {
  Axios3.prototype[method2] = function(url, config3) {
...
// node_modules/laravel-precognition/node_modules/axios/lib/cancel/CancelToken.js
var CancelToken3 = class _CancelToken {
  constructor(executor) {
    ...
    executor(function cancel(message, config3, request2) {
      ...
      token.reason = new CanceledError_default2(message, config3, request2);
      resolvePromise(token.reason);
    });
  }
  /**
...
// node_modules/laravel-precognition/node_modules/axios/lib/helpers/spread.js
function spread4(callback) {
  return function wrap2(arr) {
    return callback.apply(null, arr);
  };
}

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/isAxiosError.js
function isAxiosError3(payload) {
  return utils_default2.isObject(payload) && payload.isAxiosError === true;
}

// node_modules/laravel-precognition/node_modules/axios/lib/helpers/HttpStatusCode.js
var HttpStatusCode3 = {
  Continue: 100,
  SwitchingProtocols: 101,
  Processing: 102,
...
// node_modules/laravel-precognition/node_modules/axios/lib/axios.js
function createInstance2(defaultConfig) {
  const context = new Axios_default2(defaultConfig);
  const instance = bind3(Axios_default2.prototype.request, context);
...
var axios2 = createInstance2(defaults_default3);
...
// node_modules/laravel-precognition/node_modules/axios/index.js
var {
  Axios: Axios4,
...
var axiosClient = axios_default2.create();
var requestFingerprintResolver = (config3, axios3) => `${config3.method}:${config3.baseURL ?? axios3.defaults.baseURL ?? ""}${config3.url}`;
var successResolver = (response) => response.status === 204 && response.headers["precognition-success"] === "true";
var abortControllers = {};
var client = {
  get: (url, data = {}, config3 = {}) => request(mergeConfig5("get", url, data, config3)),
  post: (url, data = {}, config3 = {}) => request(mergeConfig5("post", url, data, config3)),
  patch: (url, data = {}, config3 = {}) => request(mergeConfig5("patch", url, data, config3)),
  put: (url, data = {}, config3 = {}) => request(mergeConfig5("put", url, data, config3)),
  delete: (url, data = {}, config3 = {}) => request(mergeConfig5("delete", url, data, config3)),
  use(axios3) {
    axiosClient = axios3;
    return client;
  },
...
var mergeConfig5 = (method2, url, data, config3) => ({
  url,
  method: method2,
  ...config3,
  ...["get", "delete"].includes(method2) ? {
    params: merge_default({}, data, config3 == null ? void 0 : config3.params)
  } : {
    data: merge_default({}, data, config3 == null ? void 0 : config3.data)
  }
});
...
var abortMatchingRequests = (config3) => {
  ...
  (_a = abortControllers[config3.fingerprint]) == null ? void 0 : _a.abort();
...
var isNotServerGeneratedError = (error) => {
  var _a;
  return !isAxiosError4(error) || typeof ((_a = error.response) == null ? void 0 : _a.status) !== "number" || isCancel4(error);
};
...
var resolveContentType = (config3) => {
  var _a, _b, _c;
  return ((_a = config3.headers) == null ? void 0 : _a["Content-Type"]) ?? ((_b = config3.headers) == null ? void 0 : _b["Content-type"]) ?? ((_c = config3.headers) == null ? void 0 : _c["content-type"]) ?? (hasFiles2(config3.data) ? "multipart/form-data" : "application/json");
};
var hasFiles2 = (data) => isFile4(data) || typeof data === "object" && data !== null && Object.values(data).some((value) => hasFiles2(value));
var isFile4 = (value) => typeof File !== "undefined" && value instanceof File || value instanceof Blob || typeof FileList !== "undefined" && value instanceof FileList && value.length > 0;
...
var createValidator = (callback, initialData = {}) => {
  ...
  const createValidator2 = () => debounce_default((instanceConfig) => {
    callback({
      ...
      if (isAxiosError4(error) && ((_a = error.response) == null ? void 0 : _a.status) === 422) {
        return null;
      }
      return Promise.reject(error);
    });
  ...
  const resolveConfig2 = (globalConfig, instanceConfig, data = {}) => {
    ...
    return {
      ...
      ...mergeConfig4(globalConfig, instanceConfig),
      only,
  ...
  const validate = (name, value, config3) => {
    if (typeof name === "undefined") {
      const only = Array.from((config3 == null ? void 0 : config3.only) ?? (config3 == null ? void 0 : config3.validate) ?? []);
      setTouched([...touched, ...only]).forEach((listener) => listener());
      validator(config3 ?? {});
      return;
    }
    if (isFile4(value) && !validateFiles) {
...
var Deferred = ({ children, data, fallback }) => {
  ...
  const propsAreDefined = (0, import_react5.useMemo)(() => keys2.every((key) => pageProps[key] !== void 0), [keys2, pageProps]);
...
function useForm(...args) {
  ...
  const [defaults4, setDefaults] = (0, import_react9.useState)(
  ...
  const [data, setData2] = rememberKey ? useRemember(defaults4, `${rememberKey}:data`, excludeKeysRef) : (0, import_react9.useState)(defaults4);
  ...
  const [progress22, setProgress] = (0, import_react9.useState)(null);
  ...
  const isDirty = (0, import_react9.useMemo)(() => !isEqual_default(data, defaults4), [data, defaults4]);
  ...
  const withAllErrors = (0, import_react9.useRef)(null);
  ...
  const submit = (0, import_react9.useCallback)(
    (...args2) => {
      const { method: method2, url, options } = UseFormUtils.parseSubmitArguments(args2, precognitionEndpoint.current);
  ...
  const reset = (0, import_react9.useCallback)(
    (...fields) => {
      ...
      if (fields.length === 0) {
        ...
        setData2(
          (data2) => fields.filter((key) => has_default(defaults4, key)).reduce(
            (carry, key) => {
              return set_default(carry, key, get_default(defaults4, key));
            },
            { ...data2 }
          )
        );
  ...
  const validate = (field, config3) => {
    ...
    if (field === void 0) {
      ...
      const transformedData = transform2.current(currentData);
  ...
  const withPrecognition = (...args2) => {
    ...
    if (!validatorRef.current) {
      const validator = createValidator((client2) => {
        const { method: method2, url } = precognitionEndpoint.current();
        const currentData = dataRef.current;
        const transformedData = transform2.current(currentData);
        return client2[method2](url, transformedData);
      }, cloneDeep_default(defaults4));
    ...
    const precognitiveForm = Object.assign(form, {
      ...
      invalid,
      touched,
      withoutFileValidation: () => tap2(precognitiveForm, () => {
        var _a;
      ...
      withAllErrors: () => tap2(precognitiveForm, () => withAllErrors.current = true),
      setValidationTimeout: (duration) => tap2(precognitiveForm, () => {
        var _a;
        return (_a = validatorRef.current) == null ? void 0 : _a.setTimeout(duration);
      }),
      validateFiles: () => tap2(precognitiveForm, () => {
        var _a;
        return (_a = validatorRef.current) == null ? void 0 : _a.validateFiles();
      }),
      validate,
      setErrors: (errors2) => tap2(precognitiveForm, () => form.setError(errors2)),
      forgetError: (field) => tap2(
        precognitiveForm,
...
var noop4 = () => void 0;
var FormContext = (0, import_react8.createContext)(void 0);
var Form = (0, import_react8.forwardRef)(
  ({
    action = "",
    method: method2 = "get",
    headers = {},
    ...
    const formElement = (0, import_react8.useRef)(void 0);
    const resolvedMethod = (0, import_react8.useMemo)(() => {
      return isUrlMethodPair(action) ? action.method : method2.toLowerCase();
    }, [action, method2]);
    const [isDirty, setIsDirty] = (0, import_react8.useState)(false);
    const defaultData = (0, import_react8.useRef)(new FormData());
    const getFormData = (submitter) => new FormData(formElement.current, submitter);
    const getData2 = (submitter) => formDataToObject(getFormData(submitter));
    ...
    const submit = (submitter) => {
      ...
      form.transform(() => transform2(data));
    ...
    (0, import_react8.useImperativeHandle)(ref, () => exposed, [form, isDirty, submit]);
    const formNode = (0, import_react8.createElement)(
      "form",
      {
        ...props,
        ref: formElement,
    ...
    return (0, import_react8.createElement)(FormContext.Provider, { value: exposed }, formNode);
  }
);
...
var InfiniteScroll = (0, import_react12.forwardRef)(
  ({
    ...
    const [hasPreviousPage, setHasPreviousPage] = (0, import_react12.useState)(false);
    const [hasNextPage, setHasNextPage] = (0, import_react12.useState)(false);
...
var WhenVisible = ({ children, data, params, buffer, as, always, fallback }) => {
  ...
  const pageProps = usePage().props;
  const keys2 = (0, import_react16.useMemo)(() => data ? Array.isArray(data) ? data : [data] : [], [data]);
  const [loaded, setLoaded] = (0, import_react16.useState)(() => keys2.length > 0 && keys2.every((key) => pageProps[key] !== void 0));
  ...
  const getReloadParamsRef = (0, import_react16.useRef)(() => ({}));
